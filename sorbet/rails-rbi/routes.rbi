...
module GeneratedUrlHelpers
  ...
  # Sigs for route /ideas(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def ideas_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def ideas_url(*args, **kwargs); end

  # Sigs for route /ideas/new(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def new_idea_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def new_idea_url(*args, **kwargs); end

  # Sigs for route /ideas/:id/edit(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def edit_idea_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def edit_idea_url(*args, **kwargs); end

  # Sigs for route /ideas/:id(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def idea_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def idea_url(*args, **kwargs); end
